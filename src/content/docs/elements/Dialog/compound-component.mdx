---
title: Dialog (Compound Component)
...
import DialogRaw from '@/components/elements/dialog/compound-component/Dialog.ts?raw'
import DialogRootRaw from '@/components/elements/dialog/compound-component/Root.astro?raw'
import DialogContentRaw from '@/components/elements/dialog/compound-component/Content.astro?raw'
import DialogTriggerRaw from '@/components/elements/dialog/compound-component/Trigger.astro?raw'
...
<Aside>
  ...
  [here](https://github.com/vigetlabs/blueprint-starlight/blob/master/config/tailwind/dialog.js).
</Aside>
  ...
  <Preview.Docs>
    <Tabs>
      ...
      <TabItem label="Compiled" icon="seti:html">
        ...
        <custom-dialog>
          <dialog data-dialog="dialog" class="dialog">
            <button type="button" title="Close" data-component="Button" data-dialog="close" class="btn-subtle btn-sm btn-icon absolute right-4 top-4 size-24 !min-h-0 [&_svg]:size-12">
              <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 15 14"><path d="M14.57 1.41L13.16 0 7.57 5.59 1.98 0 .57 1.41 6.16 7 .57 12.59 1.98 14l5.59-5.59L13.16 14l1.41-1.41L8.98 7l5.59-5.59z"></path></svg>
              Close
            </button>
            <form method="dialog" class="grid gap-24">
