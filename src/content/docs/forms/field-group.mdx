...
The `<FieldGroup>` component is designed with accessibility in mind. The following are some of the key accessibility features that are included in the component and worth considering:
