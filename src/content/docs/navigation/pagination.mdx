    ...
    <Tabs class="border-none">
      ...
      <TabItem label="Compiled" icon="seti:html">
        ...
        <nav aria-label="pagination navigation" data-component="Pagination">
          <ul class="flex list-none flex-wrap items-center p-0 gap-10">
            <li>
            ...
            <li>
              <a
                ...
                class="btn-subtle !min-h-0 items-center justify-center rounded-full !p-0 text-center ring-inset hover:ring-1 hover:ring-sky-700 dark:hover:ring-white size-44"
              >
            ...
            <li>
              <a
                href="?page=3"
                data-component="Button"
                class="btn-contained !min-h-0 items-center justify-center rounded-full !p-0 text-center ring-inset hover:ring-1 hover:ring-sky-700 dark:hover:ring-white size-44"
              >
                <span class="sr-only">Go to page</span>
                3
              </a>
