...
The `<Select>` component is designed with accessibility in mind and extends much of the accessibility features from the [`<Field Group>` component](/forms/field-group/#accessibility). The following are some of the field specific accessibility features that are included in the component and worth considering:
