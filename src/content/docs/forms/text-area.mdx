---
title: Text Area
description: The text area component is used to collect large amounts of text from the user.
---
...
import TextAreaRaw from '@/components/forms/TextArea.astro?raw'

Text area components are used to collect large amounts of text from the user.

<Aside>
  Textarea styles are generated via a [Tailwind
  ...
  <Preview.Docs>
    <Tabs>
      <TabItem label="Astro" icon="astro">
        ```astro
        <TextArea label="Label" name="example-1" placeholder="Placeholder" />
        ```
      </TabItem>
...
<PropTable
  rows={[
    ...
    },
    {
      prop: 'label',
      type: 'string',
      description: 'Visual or assistive label for the textarea',
      required: true,
    },
    {
      prop: 'labelHidden',
    ...
    },
    {
      prop: 'sublabel',
      type: 'string',
      description: 'Sub-label content for the textarea',
    },
    {
      prop: 'instructions',
      type: 'string',
    ...
    },
    {
      ...
      description: 'Additional attributes to pass to the textarea field',
    },
    {
      prop: 'errorMessages',
      type: 'string[]',
      description: 'Error messages to display below the textarea',
    },
...
The `<TextArea>` component is designed with accessibility in mind and extends much of the accessibility features from the [`<Field Group>` component](/forms/field-group/#accessibility). The following are some of the field specific accessibility features that are included in the component and worth considering:
...
Use the `sublabel` and `instructions` props to add helper text to the textarea.
...
Use the `errorMessages` prop to display error messages below the textarea.
...
<Code code={TextAreaRaw} lang="astro" title="TextArea.astro" />
