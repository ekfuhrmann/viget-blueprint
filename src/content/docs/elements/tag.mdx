...
import TagRaw from '@/components/elements/Tag.astro?raw'
  ...
  <Preview.Docs>
    <Tabs>
      ...
      <TabItem label="Compiled" icon="seti:html">
        ...
        <span
          data-component="Tag"
          class="inline-flex min-h-20 items-center justify-center gap-4 rounded-sm bg-sky-600 px-6 text-center text-xs font-medium text-white focus:outline-none focus-visible:ring-4 dark:bg-sky-200 dark:text-sky-800 [&_svg]:size-12"
        >
          Tag
        </span>
        ```
  ...
  <Preview.Docs>
    <Tabs>
      ...
      <TabItem label="Compiled" icon="seti:html">
        ...
        <span
          data-component="Tag"
          class="inline-flex min-h-20 items-center justify-center gap-4 rounded-sm border border-sky-600 bg-transparent px-6 text-center text-xs font-medium text-sky-600 focus:outline-none focus-visible:ring-4 dark:border-white dark:text-white [&_svg]:size-12"
        >
          Tag
        </span>
        ```
