...
<Preview.Root>
  ...
  <Preview.Docs>
    <Tabs>
      ...
      <TabItem label="Compiled" icon="seti:html">
        ```html
        <div class="field-group max-w-xs" data-required="" data-layout="FieldGroup" data-component="TextInput">
        ...
        <div class="field-group max-w-xs" data-required="long" data-layout="FieldGroup" data-component="TextInput">
